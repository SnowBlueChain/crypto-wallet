...
export class AlertsPage {
  ...
  public onAlertOverviewButtonClicked(alert: Alert): void {
    console.warn("Alert chart button has been clicked for the following alert: " + alert.id);
  }
  ...
  public onDeleteAlertButtonClicked(alert: Alert): void {
    console.warn("Delete alert button has been clicked for the following alert: " + alert.id);
  }
}