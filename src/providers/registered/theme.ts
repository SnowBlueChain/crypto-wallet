...
export class RegisteredThemeProvider {
  ...
  private readonly allThemesPath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/registered/TOKEN/theme";
  private readonly getThemePath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/registered/TOKEN/theme/ID";
