...
export class AdministratorThemeProvider {
  ...
  private readonly allThemesPath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/administrator/TOKEN/theme";
  private readonly getThemePath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/administrator/TOKEN/theme/ID";
  private readonly insertThemePath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/administrator/TOKEN/theme";
  private readonly updateThemePath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/administrator/TOKEN/theme/ID";
  private readonly deleteThemePath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/administrator/TOKEN/theme/ID";
