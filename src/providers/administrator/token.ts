...
export class AdministratorTokenProvider {
  ...
  private readonly allTokensPath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/administrator/TOKEN/token";
  private readonly getTokenPath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/administrator/TOKEN/token/ID";
  private readonly deleteTokenPath: string = "https://cryptowallet.loic-delorme.fr/api/cryptowallet/administrator/TOKEN/token/ID";
